...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/cmake/tracepoint-decode/tracepoint-decodeTargets.cmake")
    ...
    if(EXPORT_FILE_CHANGED)
      ...
      if(OLD_CONFIG_FILES)
        message(STATUS "Old export file \"$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib64/cmake/tracepoint-decode/tracepoint-decodeTargets.cmake\" will be replaced.  Removing files [${OLD_CONFIG_FILES}].")
